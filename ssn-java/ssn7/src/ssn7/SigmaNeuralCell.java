...
public class SigmaNeuralCell {
		...
		public double finalizeData(double membranePotential)
		{
			...
			System.out.println("================");
			System.out.println(1 / (1 + Math.exp(-membranePotential)));
			return 1 / (1 + Math.exp(-membranePotential));
		}
		 ...
		 * Adds new field for input.
		 */
//		public void aaaaaaddInputs(double input1, double input2)
//		{
//			Dendrites.add(input1);
//			Dendrites.add(input2);
//			// Synapses.add(1.0);
//		}
